...
#models=[lr_model,tree_model,rfr_model,gbdt_model,xgb_model,gbm_model]
models=[lr_model,tree_model,rfr_model,gbdt_model,xgb_model]
#model_names=['lr_model','tree_model','rfr_model','gbdt_model','xgb_model','gbm_model']
...
#y_gbm_predict = gbm_model.predict(test_x)

fig=plt.figure(figsize=(30,8))
plt.style.use('ggplot')
#predicts=[y_lr_predict,y_tree_predict,y_rfr_predict,y_gbdt_predict,y_xgb_predict,y_gbm_predict]
predicts=[y_lr_predict,y_tree_predict,y_rfr_predict,y_gbdt_predict,y_xgb_predict]
#colors=['r','g','y','b','c','grey']
colors=['r','g','y','b','c']
