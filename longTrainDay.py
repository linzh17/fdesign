...
trainData = np.loadtxt('/home/lin/Desktop/课程作业/毕业论文/cleanData/longSeries/dataNumpy/dayLongNumpy.csv')
print(trainData.shape[1])
trainData = trainData.reshape(1478,519,1)
print(trainData)
...
trainData = TimeSeriesScalerMeanVariance(mu=0.0, std=1.0).fit_transform(trainData)
#trainData = TimeSeriesResampler(sz=50).fit_transform(trainData)
